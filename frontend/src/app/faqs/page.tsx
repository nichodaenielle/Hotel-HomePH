          ...
          >
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-accent to-accent-300 px-5 py-2.5 text-xs font-semibold text-brand-blue transition-all duration-300 hover:shadow-[0_0_15px_rgba(249,205,42,0.3)] hover:-translate-y-0.5 active:scale-95"
              >
