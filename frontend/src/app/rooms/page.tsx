          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                className="group inline-flex min-w-[140px] items-center justify-center gap-2 rounded-full bg-gradient-to-r from-accent to-accent-300 px-6 py-3 text-sm font-semibold text-brand-blue transition-all duration-300 hover:shadow-[0_0_20px_rgba(249,205,42,0.4)] hover:-translate-y-0.5 active:scale-95"
              >
